...
\newglossaryentry{oral}{name=Practicum check, description={The summative assessment at the end of the course, determining the final grade.}}
...
\newglossaryentry{typvar}{
      name=TYPVAR
    , description={The \Gls{lo} stating that at the end of this course: the student \textbf{can apply} the concept of type variables (Generics).}
    , first={\textbf{can apply} the concept of type variables. \texttt{(TYPVAR)}}
    , symbol=\texttt{TYPVAR}
    }
\newglossaryentry{bhf}{
      name=BHF
